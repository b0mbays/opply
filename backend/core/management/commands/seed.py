        ...
        "ingredients": [
            {
                ...
                "unit": "kg",
                "price_per_unit": "1.85",
                "description": "Whole grain rolled oats, certified organic",
            },
            {
                "name": "Dark Rye Flour",
                "unit": "kg",
                "price_per_unit": "2.10",
                "description": "Stone-ground dark rye, rich flavour",
            },
            {
                "name": "Spelt Flour",
                "unit": "kg",
                "price_per_unit": "3.40",
                "description": "Ancient grain flour, nutty and nutritious",
            },
            {
                "name": "Barley Flakes",
                "unit": "kg",
                "price_per_unit": "1.65",
                "description": "Lightly toasted barley flakes",
            },
        ],
    },
    {
        ...
        "ingredients": [
            {
                ...
                "unit": "kg",
                "price_per_unit": "7.50",
                "description": "84% fat content, European style",
            },
            {
                "name": "Double Cream",
                "unit": "litre",
                "price_per_unit": "4.20",
                "description": "48% fat, pasteurised",
            },
            {
                "name": "Full-Fat Milk Powder",
                "unit": "kg",
                "price_per_unit": "9.80",
                "description": "Spray-dried, instant dissolving",
            },
            {
                "name": "Cultured Buttermilk Powder",
                "unit": "kg",
                "price_per_unit": "11.20",
                "description": "Adds tang and tenderness to baked goods",
            },
            {
                "name": "Whey Protein Concentrate",
                "unit": "kg",
                "price_per_unit": "14.50",
                "description": "80% protein, neutral flavour",
            },
        ],
    },
    {
        ...
        "ingredients": [
            {
                ...
                "description": "Pure Madagascar vanilla, 2-fold concentration",
            },
            {
                "name": "Cacao Powder",
                "unit": "kg",
                "price_per_unit": "12.50",
                "description": "Dutch-processed, 22-24% fat",
            },
            {
                "name": "Coconut Sugar",
                "unit": "kg",
                "price_per_unit": "4.80",
                "description": "Unrefined, low GI sweetener",
            },
            {
                "name": "Desiccated Coconut",
                "unit": "kg",
                "price_per_unit": "3.20",
                "description": "Fine grade, unsweetened",
            },
        ],
    },
    {
        ...
        "ingredients": [
            {
                ...
                "unit": "litre",
                "price_per_unit": "2.10",
                "description": "High-oleic, refined, neutral flavour",
            },
            {
                "name": "Cold-Pressed Rapeseed Oil",
                "unit": "litre",
                "price_per_unit": "3.80",
                "description": "Unrefined, nutty flavour, high omega-3",
            },
            {
                "name": "Coconut Oil",
                "unit": "kg",
...
class Command(BaseCommand):
    ...
    def handle(self, *args, **kwargs) -> None:
        ...
        if not Order.objects.filter(buyer=buyer).exists():
            ...
            order_confirmed = self._create_order(
                buyer,
                [
            ...
            order_delivered = self._create_order(
                buyer,
                [
